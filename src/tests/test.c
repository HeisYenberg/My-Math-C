...
START_TEST(test_abs) {
  ck_assert_int_eq(my_abs(test_ints[_i]), abs(test_ints[_i]));
}
END_TEST

START_TEST(test_acos) {
  ck_assert_double_eq_tol(my_acos(test_acos_asin_atan[_i]),
                          acos(test_acos_asin_atan[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_asin) {
  ck_assert_double_eq_tol(my_asin(test_acos_asin_atan[_i]),
                          asin(test_acos_asin_atan[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_atan) {
  ck_assert_double_eq_tol(my_atan(test_acos_asin_atan[_i]),
                          atan(test_acos_asin_atan[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_ceil) {
  ck_assert_double_eq_tol(my_ceil(test_doubles[_i]), ceil(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_cos) {
  ck_assert_double_eq_tol(my_cos(test_doubles[_i]), cos(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_exp) {
  ck_assert_double_eq_tol(my_exp(test_doubles[_i]), exp(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_fabs) {
  ck_assert_double_eq_tol(my_fabs(test_doubles[_i]), fabs(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_floor) {
  ck_assert_double_eq_tol(my_floor(test_doubles[_i]), floor(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_fmod) {
  ck_assert_double_eq_tol(my_fmod(test_doubles[_i], test_positive_doubles[_i]),
...
START_TEST(test_log) {
  ck_assert_double_eq_tol(my_log(test_positive_doubles[_i]),
                          log(test_positive_doubles[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_pow) {
  ck_assert_double_eq_tol(my_pow(test_doubles[_i], test_ints[_i]),
                          pow(test_doubles[_i], test_ints[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_sin) {
  ck_assert_double_eq_tol(my_sin(test_doubles[_i]), sin(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_sqrt) {
  ck_assert_double_eq_tol(my_sqrt(test_positive_doubles[_i]),
                          sqrt(test_positive_doubles[_i]), MY_EPS_9);
}
END_TEST

START_TEST(test_tan) {
  ck_assert_double_eq_tol(my_tan(test_doubles[_i]), tan(test_doubles[_i]),
                          MY_EPS_9);
}
END_TEST

START_TEST(test_nan) {
  ck_assert_double_nan(my_acos(test_nans[_i]));
  ck_assert_double_nan(acos(test_nans[_i]));
  ck_assert_double_nan(my_asin(test_nans[_i]));
  ck_assert_double_nan(asin(test_nans[_i]));
  ck_assert_double_nan(my_atan(test_nans[_i]));
  ck_assert_double_nan(atan(test_nans[_i]));
  ck_assert_double_nan(my_ceil(test_nans[_i]));
  ck_assert_double_nan(ceil(test_nans[_i]));
  ck_assert_double_nan(my_cos(test_nans[_i]));
  ck_assert_double_nan(cos(test_nans[_i]));
  ck_assert_double_nan(my_exp(test_nans[_i]));
  ck_assert_double_nan(exp(test_nans[_i]));
  ck_assert_double_nan(my_fabs(test_nans[_i]));
  ck_assert_double_nan(fabs(test_nans[_i]));
  ck_assert_double_nan(my_floor(test_nans[_i]));
  ck_assert_double_nan(floor(test_nans[_i]));
  ck_assert_double_nan(my_fmod(test_nans[_i], test_nans[_i]));
  ck_assert_double_nan(fmod(test_nans[_i], test_nans[_i]));
  ck_assert_double_nan(my_log(test_nans[_i]));
  ck_assert_double_nan(log(test_nans[_i]));
  ck_assert_double_nan(my_pow(test_nans[_i], test_nans[_i]));
  ck_assert_double_nan(pow(test_nans[_i], test_nans[_i]));
  ck_assert_double_nan(my_sin(test_nans[_i]));
  ck_assert_double_nan(sin(test_nans[_i]));
  ck_assert_double_nan(my_sqrt(test_nans[_i]));
  ck_assert_double_nan(sqrt(test_nans[_i]));
  ck_assert_double_nan(my_tan(test_nans[_i]));
  ck_assert_double_nan(tan(test_nans[_i]));
}

START_TEST(cover_all) {
  ck_assert_double_nan(my_acos(2.3223));
  ck_assert_double_nan(acos(2.3223));
  ck_assert_double_nan(my_asin(2.3223));
  ck_assert_double_nan(asin(2.3223));
  ck_assert_double_nan(my_log(-2.3223));
  ck_assert_double_nan(log(-2.3223));
  ck_assert_double_eq(my_pow(-INFINITY, INFINITY), pow(-INFINITY, INFINITY));
  ck_assert_double_eq(my_pow(-INFINITY, -INFINITY), pow(-INFINITY, -INFINITY));
  ck_assert_double_eq(my_pow(0, 0), pow(0, 0));
  ck_assert_double_nan(my_pow(-1, 1.2));
  ck_assert_double_nan(pow(-1, 1.2));
  ck_assert_double_nan(my_sqrt(-1));
  ...
  ck_assert_double_eq(my_fmod(23, INFINITY), fmod(23, INFINITY));
}
Suite *s21_math_tests() {
